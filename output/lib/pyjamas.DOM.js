...
pyjamas.DOM.eventGetFromElement = function(evt) {
	...
	try {
		...
		var pyjs_try_err_name = (typeof pyjs_try_err.__name__ == 'undefined' ? pyjs_try_err.name : pyjs_try_err.__name__ );
		$pyjs.__last_exception__ = {error: pyjs_try_err, module: pyjamas.DOM, try_lineno: 260};
		{
			$pyjs.__last_exception__.except_lineno = 263;
			err = pyjs_try_err;
			return null;
		} 	}
	return null;
...
pyjamas.DOM.getAbsoluteLeft = function(elem) {
	...
	parent = (typeof elem.offsetParent == 'function' && elem.__is_instance__?pyjslib.getattr(elem, 'offsetParent'):elem.offsetParent);
	if (pyjslib.bool((parent) && (pyjslib.eq((typeof parent.tagName == 'function' && parent.__is_instance__?pyjslib.getattr(parent, 'tagName'):parent.tagName), String('BODY'))) && (pyjslib.hasattr(elem, String('style'))) && (pyjslib.eq(pyjamas.DOM.getStyleAttribute(elem, String('position')), String('absolute'))))) {
		break;
	}
	elem = parent;
    }
	return  ( left + (typeof $doc.body.scrollLeft == 'function' && $doc.body.__is_instance__?pyjslib.getattr($doc.body, 'scrollLeft'):$doc.body.scrollLeft) ) ;
	return null;
};
...
pyjamas.DOM.getAbsoluteTop = function(elem) {
	...
	return  ( top + (typeof $doc.body.scrollTop == 'function' && $doc.body.__is_instance__?pyjslib.getattr($doc.body, 'scrollTop'):$doc.body.scrollTop) ) ;
	return null;
};
...
pyjamas.DOM.getInnerHTML = function(element) {
	...
	try {
		...
		var pyjs_try_err_name = (typeof pyjs_try_err.__name__ == 'undefined' ? pyjs_try_err.name : pyjs_try_err.__name__ );
		$pyjs.__last_exception__ = {error: pyjs_try_err, module: pyjamas.DOM, try_lineno: 454};
		{
			$pyjs.__last_exception__.except_lineno = 457;
			err = pyjs_try_err;
			return (element) && ((typeof element.innerHTML == 'function' && element.__is_instance__?pyjslib.getattr(element, 'innerHTML'):element.innerHTML));
		} 	}
	return null;
...
pyjamas.DOM.getStyleAttribute = function(elem, attr) {
	...
	try {
		...
		var pyjs_try_err_name = (typeof pyjs_try_err.__name__ == 'undefined' ? pyjs_try_err.name : pyjs_try_err.__name__ );
		$pyjs.__last_exception__ = {error: pyjs_try_err, module: pyjamas.DOM, try_lineno: 502};
		{
			$pyjs.__last_exception__.except_lineno = 507;
			err = pyjs_try_err;
			return null;
		} 	}
	return null;
...
pyjamas.DOM.IterChildrenClass = (function(){
	...
	cls_definition.__md5__ = 'd7a80979f868cd0b611a8a194509fea4';
...
pyjamas.DOM.IterWalkChildren = (function(){
	...
	var cls_definition = new Object();
	cls_definition.__md5__ = '04d467dd14c67f243bdd63a8c1e61423';
	cls_definition.__init__ = pyjs__bind_method(cls_instance, '__init__', function(elem) {
		if (this.__is_instance__ === true) {
			var self = this;
		} else {
...
pyjamas.DOM.setInnerHTML = function(element, html) {
	...
	try {
		...
		var pyjs_try_err_name = (typeof pyjs_try_err.__name__ == 'undefined' ? pyjs_try_err.name : pyjs_try_err.__name__ );
		$pyjs.__last_exception__ = {error: pyjs_try_err, module: pyjamas.DOM, try_lineno: 689};
		{
			$pyjs.__last_exception__.except_lineno = 692;
			err = pyjs_try_err;
			element.innerHTML = html;
		} 	}
	return null;

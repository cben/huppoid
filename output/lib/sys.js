...
sys.exc_info = function() {
	...
	return new pyjslib.Tuple([(typeof le.error.__class__ == 'function' && le.error.__is_instance__?pyjslib.getattr(le.error, '__class__'):le.error.__class__), (typeof le.error == 'function' && le.__is_instance__?pyjslib.getattr(le, 'error'):le.error), null]);
};

...
pyjamas.Window.onError = function(msg, url, linenumber) {
	...
	tracestr = sys.trackstackstr($pyjs.trackstack.slice(0,-1));
...
pyjamas.Window.init = function() {
	...
	import_sys.__name__ = 'import_sys';

	import_sys.__bind_type__ = 0;
	import_sys.__args__ = [null,null];
	pyjamas.Window.sys = import_sys();
